...
with st.sidebar:
    st.markdown("### ⚙️ 설정")
    st.caption("출퇴근 감지와 기록 옵션을 관리합니다.")
    ...
    worker = st.selectbox("작업자", worker_options, index=current_idx, format_func=lambda x: x or "이름을 선택하세요")
